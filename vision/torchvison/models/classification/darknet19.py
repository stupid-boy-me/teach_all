# https://blog.csdn.net/kuweicai/article/details/115028122
# 可以看到 Darknet-19 的性能基本与 Resnet34 差不多。
import torch
...
def darknet19():
    return DarkNet_19(num_classes=1000).to("cuda")


if __name__ == "__main__":
    model_darknet19 = darknet19()
    summary(model_darknet19,(3,224,224))