...
def efficientnet(subtype='efficientnet_b0', num_classes=1000):
    
    return EfficientNet(subtype=subtype, num_classes=num_classes).to("cuda")

if __name__ == "__main__":
    model_efficientnet = efficientnet(subtype='efficientnet_b0', num_classes=1000)
    summary(model_efficientnet,(3,224,224))
