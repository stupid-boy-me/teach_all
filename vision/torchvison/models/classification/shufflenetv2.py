...
if __name__ == '__main__':
    model_shufflenet_v2_x0_5 = shufflenet_v2_x0_5(num_classes=1000).to('cuda')
    summary(model_shufflenet_v2_x0_5,(3,224,224))
    model_shufflenet_v2_x1_0 = shufflenet_v2_x1_0(num_classes=1000).to('cuda')
    summary(model_shufflenet_v2_x1_0,(3,224,224))
    model_shufflenet_v2_x1_5 = shufflenet_v2_x1_5(num_classes=1000).to('cuda')
    summary(model_shufflenet_v2_x1_5,(3,224,224))
    model_shufflenet_v2_x2_0 = shufflenet_v2_x2_0(num_classes=1000).to('cuda')  
    summary(model_shufflenet_v2_x2_0,(3,224,224))