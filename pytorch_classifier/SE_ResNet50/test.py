...
parser.add_argument("--test_dir",default=r'E:\Project\tiankong_datasets\script\deep_learning_me\pytorch_classification_me\Dataset\data_animals_ten\animals10\raw_img_output\test\\',type=str,help='type of dataset')
parser.add_argument("--weights_path",default=r'E:\Project\tiankong_datasets\script\deep_learning_me\pytorch_classification_me\2_SE_ResNet\weights\model_new-30-of-1000-0.8569433093070984-0.5566666666666666.pth',type=str,help='weights_path')
parser.add_argument("--json_path",default=r'E:\Project\tiankong_datasets\script\deep_learning_me\pytorch_classification_me\2_SE_ResNet\class_indices.json',type=str,help='json_path')
...
def main():
    ...
    for class_ in os.listdir(args.test_dir):
        ...
        for filename in tqdm(os.listdir(class_path)):
            ...
            if not os.path.exists(image_path):
                ...
                # 1.model 第一次放入GPU
                create_model = SEResNet(num_class=10).to(device)
                # 2. model权重文件
    ...
    #             # logging.info("{}路径图像的类别是:==>{}!".format(image_path,class_indict[str(predict_cla)])) # class: horse   prob: 0.182
    #         # print_res = "class: {}   prob: {:.3}".format(class_indict[str(predict_cla)],predict[predict_cla].numpy())
    #             # print("predict_cla",predict_cla) # predict_cla 3
