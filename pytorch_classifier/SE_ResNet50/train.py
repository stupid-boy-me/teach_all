...
parser.add_argument("--root_datasets",default=r"E:\Project\tiankong_datasets\script\deep_learning_me\pytorch_classification_me\Dataset\data_animals_ten\animals10\raw-img\\",help='Dataset directory path')
parser.add_argument("--target_data_folder",default=r"E:\Project\tiankong_datasets\script\deep_learning_me\pytorch_classification_me\Dataset\data_animals_ten\animals10\raw_img_output\\",help='Dataset directory path')
'''这个不懂'''
parser.add_argument('--balance_data', action='store_true',help="Balance training data by down-sampling more frequent labels.")
parser.add_argument('--net', default="SEResNet",help="The network architecture, it can be resnet18, resnet50,or resnet152.")
...
def main():
    ...
    if args.net == 'SEResNet':
        create_net = SEResNet(num_class=10).to(device)
    ...
    transform = {
        "train": transforms.Compose([
            ...
            transforms.Normalize([0.5106215, 0.49528277, 0.40684205], [0.22238213, 0.22119278, 0.22469962])
        ]),
    ...
    for epoch in range(args.num_epochs):
        ...
        torch.save(create_net.state_dict(), r"E:\Project\tiankong_datasets\script\deep_learning_me\pytorch_classification_me\2_SE_ResNet\weights/model_new-{}-of-{}-{}-{}.pth".format(epoch,args.num_epochs,mean_loss,acc))
