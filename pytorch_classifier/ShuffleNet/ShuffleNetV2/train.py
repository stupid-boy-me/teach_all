...
parser.add_argument('--net', default="shufflenet_v2_x1_0",help="The network architecture, it can be ShuffleNetv1, ShuffleNetv2.")
...
def main():
    ...
    if args.net == 'shufflenet_v2_x1_0':
        create_net = shufflenet_v2_x1_0(num_classes=5).to(device)
    transform = {
    ...
    for epoch in range(args.num_epochs):
        ...
        if (epoch+1) % 5 == 0:
            torch.save(create_net.state_dict(), "/algdata01/yiguo.huang/hyg_deep_learning_me/ShuffleNet/ShuffleNetv2/weights/model_new-{}-of-{}-{}-{}.pth".format(epoch+1,args.num_epochs,mean_loss,acc))
