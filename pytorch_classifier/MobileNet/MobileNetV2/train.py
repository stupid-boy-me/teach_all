...
parser.add_argument("--Save_Confusion_Matrix_folder",default="/algdata01/yiguo.huang/hyg_deep_learning_me/MobileNet/MobileNetv2_update/Confusion_Matrix_picture//",help='Dataset directory path')
parser.add_argument("--Save_weights_folder",default="/algdata01/yiguo.huang/hyg_deep_learning_me/MobileNet/MobileNetv2_update/weights_folder//",help='target_data_folder directory path')
...
parser.add_argument('--num_classes', default=10, type=int,help='class_num for training')
...
def main():
    ...
    for epoch in range(args.num_epochs):
        ...
        f = plot_confusion_matrix(metric.confusion_matrix(),args.num_classes,args.class_label,[10,10])
