...
parser.add_argument("--weights_path",default='/algdata01/yiguo.huang/hyg_deep_learning_me/MobileNet/MobileNetv3/weights_folder/model-60-of-500-0.6413354873657227-0.7577889447236181.pth',type=str,help='weights_path')
    ...
    for class_ in os.listdir(args.test_dir):
        ...
        for filename in tqdm(os.listdir(class_path)):
            ...
            if not os.path.exists(image_path):
                ...
                # 1.model 第一次放入GPU
                create_model = MobileNetV3_small(num_classes=5).to(device)
                # 2. model权重文件
